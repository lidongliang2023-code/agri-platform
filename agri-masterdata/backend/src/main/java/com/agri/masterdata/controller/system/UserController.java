...
public class UserController {
    ...
    @PutMapping("/{id}/realNameStatus")
    public ApiResponse<Void> updateRealNameStatus(@PathVariable Long id, @RequestParam String realNameStatus) {
        userService.updateRealNameStatus(id, realNameStatus);
        return ApiResponse.success();
    }
    ...
    @PutMapping("/{id}/loginInfo")
    public ApiResponse<Void> updateLoginInfo(@PathVariable Long id, @RequestParam String loginIp) {
        userService.updateLoginInfo(id, loginIp);
        return ApiResponse.success();
    }

    @PostMapping("/merge")
    public ApiResponse<Void> mergeUsers(@RequestParam List<Long> sourceUserIds, @RequestParam Long targetUserId) {
        userService.mergeUsers(sourceUserIds, targetUserId);
        return ApiResponse.success();
    }

    @PostMapping("/{id}/split")
    public ApiResponse<Void> splitUser(@PathVariable Long id) {
        userService.splitUser(id);
        return ApiResponse.success();
    }
}
